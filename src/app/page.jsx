...
const cards = [
  {
    ...
    description: 'Cours guidés, circuit 3D, tuyauteries colorées, notes terrain et checkpoints.',
    icon: BookOpen,
  ...
  },
  {
    ...
    description: 'Teste des défauts types, règle BP/HP/SH/SR et observe les conséquences sur le circuit.',
    icon: Gauge,
        ...
        <nav className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Circuit frigorifique 3D interactif</p>
            </div>
          </div>
        ...
        <div className="grid flex-1 items-center gap-10 py-16 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <h1 className="max-w-4xl text-5xl font-black leading-[0.98] tracking-tight text-white md:text-7xl">
              Le froid expliqué pour le terrain.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-400">
              Une application de formation CVC pour nouveaux arrivants : cours progressifs, vrai circuit 3D interactif, états du fluide visibles, diagnostic assisté et diagramme Mollier pédagogique.
            </p>
