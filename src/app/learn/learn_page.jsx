    ...
    <main className="min-h-screen bg-[#020617] text-slate-200">
      <div className="flex min-h-screen flex-col lg:flex-row">
        <aside className="flex w-full flex-col border-r border-slate-800 bg-slate-950/80 lg:h-screen lg:w-[39rem]">
          ...
          <details className="border-b border-slate-800 bg-slate-950/70">
            <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-5 py-4 text-sm font-black text-white transition hover:bg-slate-900/70">
              <span>
                <span className="block text-[10px] uppercase tracking-[0.24em] text-blue-300">Navigation du module</span>
                <span className="mt-1 block text-slate-200">{String(currentChapterIndex + 1).padStart(2, '0')} · {chapter.title}</span>
              </span>
              <span className="rounded-xl border border-slate-700 bg-slate-900 px-3 py-2 text-[10px] uppercase tracking-[0.16em] text-slate-400">Chapitres</span>
            </summary>
            <div className="max-h-72 overflow-y-auto border-t border-slate-800 p-4">
